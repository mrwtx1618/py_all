...
def compare_k(list_one,list_two):#list_one是用户输入的列表,list_two是与之要比较的列表
    ...
    for i in xrange(len(list_one)-1):#取出列表中的前n-1个元素，因为除了最后一个元素之外,其他都要作为分母
...
all_share_codes = ['sh600666','sh600111','sz300576','sh600005','sh600006','sh600007','sh600008','sh600009','sh600010','sh600011','sh600015','sh600016','sh600017','sh600018','sh600019','sh600020','sh600021','sh600023','sh600026','sh600027','sh600028']
...
for single_share in all_share_codes:
    ...
    for item in the_collection.find():
        ...
        if item['price_list_of_list'] == []:
            ...
            for i in xrange(len(single_list_300)):
